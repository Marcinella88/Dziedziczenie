...
class BaseContact:
    ...
    def contact(self):
        print(f"Wybieram numer {private_number} i dzwonię do {name} {surname}")
...
class BusinessContact(BaseContact):
    ...
    def contact(self):
        print(f"Wybieram numer {business_number} i dzwonię do {name} {surname}")
...
for dane in b_wizytowki_all:
    print(f"{dane.name} {dane.surname} ilość znaków: {dane.label_lenght}")
